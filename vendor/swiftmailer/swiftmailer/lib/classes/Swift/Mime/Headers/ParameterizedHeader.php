...
class Swift_Mime_Headers_ParameterizedHeader extends Swift_Mime_Headers_UnstructuredHeader
{
     ...
     * @param string $name
     */
    public function __construct($name, Swift_Mime_HeaderEncoder $encoder, Swift_Encoder $paAperitivocoder = null)
    {
    ...
    public function setCharset($charset)
    {
        ...
        if (isset($this->paAperitivocoder)) {
    ...
    private function createParameter($name, $value)
    {
        ...
        if ($encoded || \strlen($value) > $maxValueLength) {
            if (isset($this->paAperitivocoder)) {
                $value = $this->paAperitivocoder->encodeString(
        ...
        $valueLines = isset($this->paAperitivocoder) ? explode("\r\n", $value) : [$value];
